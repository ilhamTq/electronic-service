...
export async function GET(request: Request) {
        ...
        <div class="container">
          ...
          <div class="content">
            ...
            <p style="text-align: center">
              Nomor: 031/64.02.16.2005-PD/Ket./IX/ 2024
            </p>
            ...
            <div class="details">
              <table>
                ...
                <tr>
                  ...
                  <td>:</td>
                  <td>${data.nikah_tempat_lahir} / ${dayjs(data.nikah_tgl_lahir).format("DD MMMM YYYY")}</td>
                </tr>
                <tr>
                  <td></td>
                  <td>Suku / Bangsa</td>
          ...
          <div class="signature">
            <p>Kerta Buana,${dayjs(data.nikah_created).format("DD MMMM YYYY")}</p>
  ...
  return new NextResponse(pdfBuffer, {
    headers: {
      ...
      'Content-Disposition': `attachment; filename="suket_belum_nikah_${id}.pdf"`,
    },
  });
}
